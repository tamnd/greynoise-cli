...
```
greynoise <command> [arguments] [flags]
```

Run `greynoise <command> --help` for the full flag list on any command. This
...
per operation you declare in `greynoise/domain.go`.

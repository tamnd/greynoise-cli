...
// HTTP behaviour is covered in greynoise_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "greynoise://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("greynoise", "about")
	if err != nil || got.String() != "greynoise://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want greynoise://page/about", got.String(), err)
	}
}
